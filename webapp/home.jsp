...
<%--            <div class="main">--%>
<%--              <strong class="subject">--%>
<%--                <a href="/qna/show?questionId=${question.questionId}">국내에서 Ruby on Rails와 Play가 활성화되기 힘든 이유는 뭘까?</a>--%>
<%--              </strong>--%>
<%--              <div class="auth-info">--%>
<%--                <i class="icon-add-comment"></i>--%>
<%--                <span class="time">2016-01-15 18:47</span>--%>
<%--                <a href="/user/profile?userId=${question.writerId}" class="author">자바지기</a>--%>
<%--              </div>--%>
<%--              <div class="reply" title="댓글">--%>
<%--                <i class="icon-reply"></i>--%>
